...
const ImageComponent = (props: ImageComponentProps) => {
  const { postedAt, postedBy, Image, posterProfilePic, likes, comments, imageCaption } =
    props;
  ...
  return (
    <div className="my-5">
      ...
      <div>
        <p><span className="font-bold">{postedBy.slice(0, -5)} :</span>  {imageCaption}</p>
      </div>
    </div>
  );
};
...
//border-t-[1px] border-b-[1px] border-gray-500
